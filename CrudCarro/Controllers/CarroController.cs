...
namespace CrudCarro.Controllers
{
    public class CarroController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Marca,Modelo,Ano,Cor,Preco")] Carro carro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Marca,Modelo,Ano,Cor,Preco")] Carro carro)
        {
            if (id != carro.Id)
            {
                return NotFound();
